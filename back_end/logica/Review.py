...
class Review:
	...
	def __init__ (this, id = None, experience, rating):
		if id != None:
			this.setId(id)
	...
	#Seter de experience
		#Si experience no es un un objeto de la clase Experience se lanza una excepción
	...
	#Seter de rating
		#Si rating no es un un objeto de la clase Rating se lanza una excepción
